...
public class CategoryModelOutput
{
    ...
    public static CategoryModelOutput FromCategory(DomainEntity.Category category) => new CategoryModelOutput(category.Id, category.Name, category.Description, category.IsActive, category.CreatedAt);
}
