...
public class ListCategoriesTest
{
    ...
    public ListCategoriesTest(ListCategoryTestFixture fixture) => _fixture = fixture;
    ...
    [Trait("Application", "ListCategories - Use Cases")]
    [MemberData(nameof(ListCategoriesTestDataGenerator.GetInputsWithoutAllParameters), parameters: 20, MemberType = typeof(ListCategoriesTestDataGenerator))]
